 ...
 * module.config.php
 *
 * Configurações do módulo Application: rotas, controllers, serviços e view_manager.
 * Comentários: este arquivo registra o EntityManager no service manager e as
 * factories necessárias. É crítico para o bootstrap do módulo.
 */
        ...
        'factories' => [
            ...
            Controller\DetalhesFilmeController::class => function($container) {
                return new Controller\DetalhesFilmeController();
                    ...
                    // Registrar FilmesController injetando o EntityManager (necessário no construtor)
                    Controller\FilmesController::class => function($container) {
                        $em = $container->get(\Doctrine\ORM\EntityManager::class);
                        return new Controller\FilmesController($em);
                    },
        ],
    ],
