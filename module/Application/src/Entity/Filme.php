 ...
 * Entity: Filme
 *
 * Representa a entidade Filme persistida via Doctrine ORM (tabela `filmes`).
 * Usamos PHP 8 attributes para mapeamento. Esta entidade contém os campos
 * usados por controllers e views e getters/setters simples.
 */
