...
document.getElementById("formFilme").addEventListener("submit", function(e) {
    ...
    const atoresPrincipais = document.getElementById("atoresPrincipais").value;
    ...
    const capaFundo = document.getElementById("capaFundo").value;
...
function editarFilme(id) {
    ...
    if (filme) {
        ...
        document.getElementById("atoresPrincipais").value = filme.atoresPrincipais; // Corrigido aqui
        document.getElementById("streaming").value = filme.streaming.join(", "); // Corrigido para exibir múltiplos streamings
        document.getElementById("ano").value = filme.anoLancamento;
        document.getElementById("capaPrincipal").value = filme.capaPrincipal;
        document.getElementById("capaFundo").value = filme.capaFundo;
        document.getElementById("trailer").value = filme.trailer;
        document.getElementById("sinopse").value = filme.sinopse;

        // Alterar o evento de submit para editar o filme em vez de adicionar um novo
...
function atualizarFilme(id) {
    ...
    if (filme) {
        ...
        filme.atoresPrincipais = document.getElementById("atoresPrincipais").value; // Corrigido aqui
        filme.streaming = document.getElementById("streaming").value.split(",").map(s => s.trim()); // Corrigido para dividir os streamings
        filme.anoLancamento = document.getElementById("ano").value;
        filme.capaPrincipal = document.getElementById("capaPrincipal").value;
        filme.capaFundo = document.getElementById("capaFundo").value;
        filme.trailer = document.getElementById("trailer").value;
        filme.sinopse = document.getElementById("sinopse").value;

        // Restaurar o comportamento do formulário para adicionar novos filmes
        const form = document.getElementById("formFilme");
        form.onsubmit = function(e) {
            e.preventDefault();
            adicionarFilme();
...
// Função de adicionar filme (restaurada para o comportamento padrão)
